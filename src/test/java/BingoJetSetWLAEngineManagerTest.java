...
public class BingoJetSetWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(BingoJetSetWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/BingoInternationalWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/BingoInternationalWLAIW/InitOutcome.xml").getDocumentElement();
